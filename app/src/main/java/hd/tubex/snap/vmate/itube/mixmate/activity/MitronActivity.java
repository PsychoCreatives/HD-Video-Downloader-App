...
import static hd.tubex.snap.vmate.itube.mixmate.util.Utils.ROOTDIRECTORYMITRON;
...
public class MitronActivity extends AppCompatActivity {
    ...
    private void showInterstitialAds() {
                ...
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(MitronActivity.this);
    ...
    public void LoadNativeAd() {
            ...
            AdLoader adLoader = new AdLoader.Builder(MitronActivity.this, getString(R.string.admob_native_ad))
