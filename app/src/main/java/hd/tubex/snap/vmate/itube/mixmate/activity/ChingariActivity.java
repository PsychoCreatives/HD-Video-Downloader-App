...
import static hd.tubex.snap.vmate.itube.mixmate.util.Utils.ROOTDIRECTORYCHINGARI;
...
public class ChingariActivity extends AppCompatActivity {
    ...
    private void showInterstitialAds() {
                ...
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(ChingariActivity.this);
    ...
    public void LoadNativeAd() {
            ...
            AdLoader adLoader = new AdLoader.Builder(ChingariActivity.this, getString(R.string.admob_native_ad))
