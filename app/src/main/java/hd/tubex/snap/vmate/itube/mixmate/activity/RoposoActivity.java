...
import static hd.tubex.snap.vmate.itube.mixmate.util.Utils.RootDirectoryRoposo;
...
public class RoposoActivity extends AppCompatActivity {
    ...
    private void showInterstitialAds() {
                ...
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(RoposoActivity.this);
        ...
        public void LoadNativeAd() {
            ...
            AdLoader adLoader = new AdLoader.Builder(RoposoActivity.this, getString(R.string.admob_native_ad))
