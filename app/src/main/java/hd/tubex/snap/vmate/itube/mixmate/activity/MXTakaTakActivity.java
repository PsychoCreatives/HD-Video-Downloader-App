...
import static hd.tubex.snap.vmate.itube.mixmate.util.Utils.ROOTDIRECTORYMX;
...
public class MXTakaTakActivity extends AppCompatActivity {
    ...
    private void showInterstitialAds() {
                ...
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(MXTakaTakActivity.this);
    ...
    public void LoadNativeAd() {
            ...
            AdLoader adLoader = new AdLoader.Builder(MXTakaTakActivity.this, getString(R.string.admob_native_ad))
